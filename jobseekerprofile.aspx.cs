...
public partial class jobseekerprofile : System.Web.UI.Page
{
    ...
    protected void savePersonalInformation_Click(object sender, EventArgs e)
    {
        ...
        j.jobSeekerId = 11;//jobseekerclass.getSeekerID(Session["LoginSession"].ToString());
    ...
    {
        int count = userprofile.checkJobSeekerEducationindfo(11);//jobseekerclass.getSeekerID(Session["LoginSession"].ToString());)
        if (count == 0)
        {
            ...
            if (Request.Form["secondinstitute"].ToString() != "")
            {
                ...
                j1.jobSeekerId = 11;//jobseekerclass.getSeekerID(Session["LoginSession"].ToString());
